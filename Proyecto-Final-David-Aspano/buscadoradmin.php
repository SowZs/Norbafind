...
<div class="margen">
<a href="crear.php">
<input class="botcrear" type="button" value="Nuevo Registro">
</a>
<?php 
                ...
                $resultado=mysqli_query($conexion,$sql);
                    if ($totalreg=="0") echo "<h2>No se han encontrado resultados</h2>";
                        else {
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="td1">
                                            <a href="modificar.php?titulo=<?php echo $find['titulo']; ?>">
                                                <input class='botedit' type="button" title="Editar" id="Modificar" name="Modificar">
                                            </a>
                                            <a href="borrar.php?titulo=<?php echo $find['titulo']; ?>">
                                                <input class='botelim' type="button" title="Eliminar" id="Eliminar" name="Eliminar">
                                            </a>
                                        </td>
